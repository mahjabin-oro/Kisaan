...
public class register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.district);
        xoxo=findViewById(R.id.logoss);
        ...
        if(fAuth.getCurrentUser() != null){
            Intent secondActivityIntent = new Intent(register.this, MainActivity.class);
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent secondActivityIntentt = new Intent(register.this, login.class);
                startActivity(secondActivityIntentt);
            }
        });
